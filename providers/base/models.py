...
class ChatRequest:
    ...
    response_format: Optional[str] = None  # "text" | "json_object" | provider-specific
    json_schema: Optional[Dict[str, Any]] = None  # Optional JSON schema for structured output
    tools: Optional[List[Dict[str, Any]]] = None  # Provider-agnostic tool specs (each adapter maps)
